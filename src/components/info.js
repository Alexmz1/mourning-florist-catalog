  ...
  return (
    <section id="information">
      <div className="container mx-auto pt-28 sm:pt-44 px-4 sm:px-6 lg:px-8 text-center max-w-screen-md">
        ...
        <p className="mt-3 text-sm sm:text-sm md:text-base lg:text-lg text-black">
          Le paiement peut s&rsquo;effectuer facilement par virement bancaire ou par carte bancaire. Nous vous rappellerons pour finaliser votre commande en toute sécurité.
        </p>
        <p className="mt-3 text-sm sm:text-sm md:text-base lg:text-lg text-black">
          De plus, nous offrons la livraison de nos compositions, veillant à ce qu&rsquo;elles arrivent à destination dans les meilleures conditions.
        </p>
        <p className="mt-3 text-sm sm:text-sm md:text-base lg:text-lg text-black">
          Nous nous engageons à vous offrir un travail de qualité, pour que chaque composition soit à la hauteur de l&rsquo;émotion que vous souhaitez partager.
        </p>
      </div>
